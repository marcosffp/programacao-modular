...
public class EuclideanDistanceMetricTest {
  ...
  void testDistance() {
    ...
    assertEquals(distanciaEsperada1, distanciaCalculada1, 0.001, "A distância entre pontos numéricos não é a esperada.");
    ...
    assertEquals(-1, distanciaCalculadaInvalida, "A distância para pontos com diferentes números de atributos deveria ser inválida (-1).");
  }
