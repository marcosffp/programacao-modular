...
public class DatasetTest {
  ...
  public void testGetAll() {
    ...
    assertEquals(1000, pessoas2.length, "Tamanho do vetor de pessoas está incorreto");
  ...
  @Test
  @DisplayName("Testando cálculo de média de renda")
  public void testAvgRenda() {
    dataset.addPessoa(pessoa1);
    assertEquals(600.54f, dataset.avgRenda(), 0.01f, "A renda média deve ser 600.54");
    dataset.removePessoa(pessoa1);
    dataset.addPessoa(pessoa2);
    dataset.addPessoa(pessoa3);
    float valorEsperado = (100.12f + 2000.12f) / 2;
    assertEquals(
        valorEsperado, dataset.avgRenda(), 0.01f, "A renda média calculada está incorreta");
  }
}
